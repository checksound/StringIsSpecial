...
public class StringsBenchMark {
	...
	public static void main(String[] args) {
		...
		// Reverse a String by building another String character-by-character in the
		// reverse order
		String strReverse = "";
		...
		// Reverse a String via an empty StringBuffer by appending characters in the
		// reverse order
		beginTime = System.nanoTime();
		...
		// Reverse a String by creating a StringBuffer with the given String and invoke
		// its reverse()
		beginTime = System.nanoTime();
		...
		// Reverse a String via an empty StringBuilder by appending characters in the
		// reverse order
		beginTime = System.nanoTime();
		...
		// Reverse a String by creating a StringBuilder with the given String and invoke
		// its reverse()
		beginTime = System.nanoTime();
